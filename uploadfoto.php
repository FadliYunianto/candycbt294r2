            ...
            if (move_uploaded_file($_FILES['zip_file']['tmp_name'], $location)) {
                ...
                foreach ($files as $file) {
                    ...
                    if (in_array($file_ext, $allowed_ext)) {
                        $output .= '<div class="col-md-3"><div style="padding:16px; border:1px solid #CCC;"><img class="img img-responsive" style="height:150px;" src="../foto/fotosiswa/' . $file . '" /></div></div>'.$files;
                    }
                }
                unlink($location);
